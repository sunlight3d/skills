...
## Configuration
The script calculates the size of the logo maintaining aspect ratio (1149x453) with a fixed width of `1,980,000 EMU`. It leaves a small margin of `100,000 EMU` from the bottom-right edges to perfectly cover most typical corner watermarks.
