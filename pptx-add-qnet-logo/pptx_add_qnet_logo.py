...
DEFAULT_IMAGE_URL = 'https://raw.githubusercontent.com/sunlight3d/skills/master/pptx-add-qnet-logo/logo_qnet.png'
...
def process_google_slides(slides_service, presentation_id, image_url, remove_only=False):
    ...
    # Dimensions for QNET logo (1149 x 453). Scaled to 1980000 width.
    ...
    if requests:
        ...
        print(f"  {action_name} QNET logo on {len(slides)} slides (skipped {skipped})...")
