...
description: >-
  Adds the Cecomtech logo to the bottom right corner of Google Slides presentations, covering previous watermark logos.
---

# PPTX Add Cecomtech Logo

## Overview
This skill automatically covers any previous logos (like NotebookLM watermarks) at the bottom right corner of a Google Slides presentation by first inserting a white rectangle with no border, and then overlaying the Cecomtech logo. It uses the Google Slides API to batch update all slides in a presentation.
